...
const Icon = (props) => {
  ...
  switch (props.icon) {
    ...
    default:
      icon = 'exclamation'
    // case "IconSaving": return (<IconSaving />)
    // case "review": return (<Review />)
  }
  return (
    <div className={'icon-mb ' + customClass}>
...
const StarFill = () => {
  return (
    <svg
      ...
      height={16}
      fill="currentColor"
      className="ms-1 text-warning bi bi-star-fill"
      viewBox="0 0 16 16"
    >
...
const Star = () => {
  return (
    <svg
      ...
      height={16}
      fill="currentColor"
      className="ms-1 text-warning bi bi-star"
      viewBox="0 0 16 16"
    >
...
const StarHalf = () => {
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="bi bi-star-half text-warning ms-1" viewBox="0 0 16 16">
